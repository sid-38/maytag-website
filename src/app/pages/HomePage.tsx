...
import { WashingMachine, Shirt, Star, MapPin, Clock, Mail } from 'lucide-react';
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Self-Service Card */}
            <div className="group flex h-[400px] bg-gray-50 rounded-2xl overflow-hidden border border-gray-200 hover:border-[#00bfb3] hover:shadow-lg transition-all">
              ...
              <div className="w-3/5 p-6 bg-gray-50 flex flex-col justify-between">
                <div>
                  ...
                  <div className="space-y-1">
                    <p className="font-semibold text-black text-sm">{t('home.services.selfService.feature1')}</p>
                    <p className="text-gray-600 text-sm">{t('home.services.selfService.feature2')}, {t('home.services.selfService.feature3')}, {t('home.services.selfService.feature4')}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="group flex h-[400px] bg-gray-50 rounded-2xl overflow-hidden border border-gray-200 hover:border-[#00bfb3] hover:shadow-lg transition-all">
              <div className="w-2/5 flex-shrink-0">
                <img
                  src="/images/wash-fold-service.jpg"
